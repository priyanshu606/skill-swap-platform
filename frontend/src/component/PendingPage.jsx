...
const PendingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 py-1 px-4 sm:px-6 lg:px-8">
        ...
        {allRequest.length === 0 ? (
          ...
          <div className="flex flex-col space-y-6">
            {allRequest.slice(start, end).map((request) => (
              <PendingCard key={request._id}  request={request} onUpdate={handleUpdate} />
            ))}
